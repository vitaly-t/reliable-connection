(function (window) {
    ...
    function ReliableConnection(config) {
        ...
        */
         ...
         */
        this.start = function () {
            if (status !== st.connected && status !== st.connecting) {
                reconnect(0)
                    .catch(function (error) {
                        updateStatus(st.error, {
                            error: error
                        });
                    });
            }
